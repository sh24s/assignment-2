...
window.addEventListener("DOMContentLoaded", () => {
  ...
  const projects = [
    { id:1, title:"To-Do List App", tags:["web","ui"], date:"2025-08-10", desc:"Add, complete, and delete tasks.", img:"assets/images/to-doList.png"},
    { id:2, title:"Timer App",       tags:["web"],       date:"2025-08-05", desc:"Start, pause, and reset a timer.", img:"assets/images/timer.png"},
  ];
